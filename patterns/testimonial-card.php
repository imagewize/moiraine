...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--xxx-large);padding-bottom:var(--wp--preset--spacing--xxx-large)">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-text-align-center has-5-xl-font-size">' . __( 'What Our Clients Say', 'moiraine' ) . '</h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-column has-border-color has-base-background-color has-background" style="border-color:#ebeced;border-width:1px;padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--x-large)">
			...
			<p class="has-2-xl-font-size">"' . __( 'Working with this team has transformed our approach to customer acquisition. We\'ve seen a 150% increase in qualified leads within just three months.', 'moiraine' ) . '"</p>
			<!-- /wp:paragraph -->
			...
			<p class="has-primary-color has-text-color has-lg-font-size" style="font-weight:600">' . __( 'Sarah Mitchell', 'moiraine' ) . '</p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-column has-border-color has-base-background-color has-background" style="border-color:#ebeced;border-width:1px;padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--x-large)">
			<!-- wp:paragraph {"fontSize":"2xl"} -->
			<p class="has-2-xl-font-size">"' . __( 'The ROI speaks for itself. Professional service, strategic thinking, and genuine partnership. Couldn\'t recommend them more highly.', 'moiraine' ) . '"</p>
			<!-- /wp:paragraph -->
			...
			<!-- wp:paragraph {"style":{"typography":{"fontWeight":"600"}},"textColor":"primary","fontSize":"lg"} -->
			<p class="has-primary-color has-text-color has-lg-font-size" style="font-weight:600">' . __( 'Michael Chen', 'moiraine' ) . '</p>
			<!-- /wp:paragraph -->
