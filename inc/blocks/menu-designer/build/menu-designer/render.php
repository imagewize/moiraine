...
<li <?php echo $wrapper_attributes; ?> data-wp-interactive='{"namespace": "moiraine/menu-designer"}' data-wp-context='{"menuOpenedBy": {}, "menuPosition": "left"}' data-wp-on-document--keydown="actions.handleMenuKeydown" data-wp-on-document--click="actions.handleOutsideClick" data-wp-watch="callbacks.initMenu">
	...
	<?php if ($menu_slug): ?>
	<div class="<?php echo $menu_classes; ?>" data-wp-class--menu-position-left="state.menuPosition === 'left'" data-wp-class--menu-position-center="state.menuPosition === 'center'" data-wp-class--menu-position-right="state.menuPosition === 'right'">
		<?php
