 ...
 * Slug: moiraine/text-call-to-action
 ...
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/desktop.webp","hasParallax":true,"dimRatio":90,"overlayColor":"primary","isUserOverlayColor":true,"minHeight":50,"metadata":{"name":"Text Call To Action"},"align":"full","className":"is-style-rounded-cover","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}}} -->
...
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'No code? No problem.', 'moiraine' ); ?></h2>
<!-- /wp:heading -->
