...
<div class="wp-block-group alignwide has-dark-teal-background-color has-base-color has-text-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xxx-large);padding-bottom:var(--wp--preset--spacing--xxx-large)">
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large)">
        ...
        <div class="wp-block-group">
            ...
            <h2 class="wp-block-heading has-base-color has-text-color" style="font-size:2.5rem;font-weight:400"><?php esc_html_e( 'Why Choose Our Solution', 'moiraine' ); ?></h2>
            <!-- /wp:heading -->
        ...
        <p class="has-base-color has-text-color" style="font-size:1.1rem;line-height:1.6"><?php esc_html_e( 'Discover the key advantages that set us apart and see why thousands of customers trust our platform to deliver exceptional results.', 'moiraine' ); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
