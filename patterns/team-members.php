...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Meet Our People', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'A small but mighty team', 'moiraine' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'We\'re a small team of diverse creators with the aim of creating the best possible WordPress products for you. Join our team today!', 'moiraine' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"metadata":{"name":"Team Members"},"align":"wide","layout":{"type":"grid","minimumColumnWidth":"20rem"}} -->
<div class="wp-block-group alignwide"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-2.webp","dimRatio":50,"overlayColor":"main","isUserOverlayColor":true,"minHeight":500,"contentPosition":"bottom center","isDark":false,"metadata":{"name":"Team Member"},"className":"is-style-rounded-cover","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|medium"}},"border":{"radius":"5px"},"dimensions":{"aspectRatio":"3/4"}}} -->
...
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-1.webp","dimRatio":50,"overlayColor":"main","isUserOverlayColor":true,"minHeight":500,"contentPosition":"bottom center","isDark":false,"metadata":{"name":"Team Member"},"className":"is-style-rounded-cover","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|medium"}},"border":{"radius":"5px"},"dimensions":{"aspectRatio":"3/4"}}} -->
...
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-3.webp","dimRatio":50,"overlayColor":"main","isUserOverlayColor":true,"minHeight":500,"contentPosition":"bottom center","isDark":false,"metadata":{"name":"Team Member"},"className":"is-style-rounded-cover","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|medium"}},"border":{"radius":"5px"},"dimensions":{"aspectRatio":"3/4"}}} -->
