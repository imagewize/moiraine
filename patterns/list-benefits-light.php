 ...
 * Slug: moiraine/list-benefits-light
...
<div class="wp-block-group alignwide has-main-color has-text-color has-tertiary-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xxx-large);padding-bottom:var(--wp--preset--spacing--xxx-large)">
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large)">
        ...
        <div class="wp-block-group">
            ...
            <h2 class="wp-block-heading has-main-color has-text-color" style="font-size:2.5rem;font-weight:400"><?php esc_html_e( 'Why Choose Our Solution', 'moiraine' ); ?></h2>
            <!-- /wp:heading -->
        ...
        <p class="has-main-color has-text-color" style="font-size:1.1rem;line-height:1.6"><?php esc_html_e( 'Discover the key advantages that set us apart and see why thousands of customers trust our platform to deliver exceptional results.', 'moiraine' ); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-group" style="border-left-color:var(--wp--preset--color--primary);border-left-width:3px;padding-left:var(--wp--preset--spacing--medium)">
            ...
            <div class="wp-block-group">
                ...
                <h3 class="wp-block-heading has-primary-color has-text-color" style="font-size:1.5rem;font-weight:500"><?php esc_html_e( 'Comprehensive Analytics', 'moiraine' ); ?></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->

            <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"}},"textColor":"main"} -->
            <p class="has-main-color has-text-color" style="line-height:1.6"><?php esc_html_e( 'Get detailed insights and real-time data visualization that help you make informed decisions and track performance across all key metrics.', 'moiraine' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group" style="border-left-color:var(--wp--preset--color--primary);border-left-width:3px;padding-left:var(--wp--preset--spacing--medium)">
            ...
            <div class="wp-block-group">
                ...
                <!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"500"}},"textColor":"primary"} -->
                <h3 class="wp-block-heading has-primary-color has-text-color" style="font-size:1.5rem;font-weight:500"><?php esc_html_e( 'Reduced Costs & Errors', 'moiraine' ); ?></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->

            <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"}},"textColor":"main"} -->
            <p class="has-main-color has-text-color" style="line-height:1.6"><?php esc_html_e( 'Minimize operational expenses and prevent costly mistakes with automated processes and intelligent error detection systems.', 'moiraine' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group" style="border-left-color:var(--wp--preset--color--primary);border-left-width:3px;padding-left:var(--wp--preset--spacing--medium)">
            ...
            <div class="wp-block-group">
                ...
                <!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"500"}},"textColor":"primary"} -->
                <h3 class="wp-block-heading has-primary-color has-text-color" style="font-size:1.5rem;font-weight:500"><?php esc_html_e( 'Faster Decision Making', 'moiraine' ); ?></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->

            <!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.6"}},"textColor":"main"} -->
            <p class="has-main-color has-text-color" style="line-height:1.6"><?php esc_html_e( 'Access streamlined workflows and instant data processing to accelerate your team\'s productivity and reduce time-to-market.', 'moiraine' ); ?></p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
    </div>
