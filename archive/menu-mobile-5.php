...
<p style="text-decoration:none"><a href="#"><?php esc_html_e( 'Library', 'moiraine' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Collections', 'moiraine' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Workflows', 'moiraine' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Analytics', 'moiraine' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Marketplace', 'moiraine' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Get Started Today', 'moiraine' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
