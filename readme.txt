...
* FIXED: Safari blinking fix - removed problematic is-style-background-blur class from menu-panel-1 pattern to eliminate Safari flickering caused by GPU compositing conflicts with backdrop-filter, border-radius, and box-shadow combinations
