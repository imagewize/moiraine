...
<div class="wp-block-group alignwide has-main-color has-text-color has-tertiary-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xxx-large);padding-bottom:var(--wp--preset--spacing--xxx-large)">
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large)">
        ...
        <div class="wp-block-group">
            <!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"var:preset|font-size|large","fontWeight":"400"}},"textColor":"main"} -->
            <h2 class="wp-block-heading has-main-color has-text-color" style="font-size:var(--wp--preset--font-size--large);font-weight:400"><?php esc_html_e( 'Why Choose Our Solution', 'moiraine' ); ?></h2>
            <!-- /wp:heading -->
        ...
        <!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|base","lineHeight":"1.6"}},"textColor":"main"} -->
        <p class="has-main-color has-text-color" style="font-size:var(--wp--preset--font-size--base);line-height:1.6"><?php esc_html_e( 'Discover the key advantages that set us apart and see why thousands of customers trust our platform to deliver exceptional results.', 'moiraine' ); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
