...
<div class="wp-block-group alignfull has-primary-accent-background-color has-background" style="padding-top:var(--wp--preset--spacing--xxx-large);padding-bottom:var(--wp--preset--spacing--xxx-large)">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%">
			...
			<h2 class="wp-block-heading has-main-color has-text-color has-link-color has-open-sans-font-family" style="margin-bottom:var(--wp--preset--spacing--x-large);;line-height:1.2">' . __( 'Get Weekly Business Growth Insights', 'moiraine' ) . '</h2>
			<!-- /wp:heading -->
			...
			<p class="has-main-accent-color has-text-color has-open-sans-font-family" style="margin-bottom:0;;line-height:1.6">' . __( 'Join 5,000+ business owners receiving actionable strategies, industry trends, and exclusive resources directly to their inbox.', 'moiraine' ) . '</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
			...
			<p class="has-text-align-center has-x-small-font-size">' . __( 'No spam. Unsubscribe anytime.', 'moiraine' ) . '</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		</div>
