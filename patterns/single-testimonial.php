 ...
 * Slug: moiraine/single-testimonial
 * Description:
 * Categories: moiraine/testimonial, moiraine/features, moiraine/card
...
<p class="has-base-color has-text-color has-large-font-size" style="line-height:1.3"><?php esc_html_e( 'Wow, I really can\'t believe how powerful the WordPress Site Editor is combined with Moiraine. I don\'t even need a page builder!', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/avatar-3.webp" alt="" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
