 ...
 * Slug: moiraine/card-call-to-action
 * Description:
...
<p class="has-base-color has-text-color"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Moiraine block theme. No coding skills required. Anyone can do it!', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-primary-accent-color has-text-color has-link-color has-x-small-font-size"><a href="#"><?php esc_html_e( 'or view on WordPress.org', 'moiraine' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
