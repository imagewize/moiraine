...
<p class="has-main-accent-color has-text-color has-small-font-size"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the Moiraine block theme. No coding skills required. Download for free today!', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->
...
<p style="font-style:normal;font-weight:600"><?php esc_html_e( 'Company', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->
...
<p><?php esc_html_e( 'About', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Brand Assets', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Contact', 'moiraine' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} -->
<p style="font-style:normal;font-weight:600"><?php esc_html_e( 'Resources', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"textColor":"main-accent","fontSize":"small","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-main-accent-color has-text-color has-small-font-size"><!-- wp:paragraph -->
<p><?php esc_html_e( 'Blog', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Support Docs', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Get Help', 'moiraine' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:column {"metadata":{"name":"Nav Column"}} -->
<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} -->
<p style="font-style:normal;font-weight:600"><?php esc_html_e( 'Product', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"textColor":"main-accent","fontSize":"small","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-main-accent-color has-text-color has-small-font-size"><!-- wp:paragraph -->
<p><?php esc_html_e( 'Features', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Use Cases', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Demo', 'moiraine' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
