 ...
 * Slug: moiraine/template-post-left-sidebar
...
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"moiraine"} /--></div>
<!-- /wp:column -->
...
<p class="has-secondary-color has-text-color"><?php esc_html_e( '·', 'moiraine' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-columns alignwide" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"width":"33.33%","className":"moiraine-hide-on-mobile"} -->
<div class="wp-block-column moiraine-hide-on-mobile" style="flex-basis:33.33%"></div>
<!-- /wp:column -->
